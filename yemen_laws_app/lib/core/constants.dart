...
class AppConstants {
  ...
  static const String feedbackIntro =
      ...
      'تحسين الأداء، وإضافة الميزات الجديدة، وتصحيح أي أخطاء قد تظهر. '
      'إذا واجهت مشكلة أو لديك اقتراح، يرجى إرساله، وسيتم مراجعته بعناية '
      'في التحديثات القادمة.';

  static const String noInternetMessage =
      'لا يوجد اتصال بالإنترنت. يرجى التحقق من الاتصال ثم المحاولة مرة أخرى.';

  static const String comingSoonMessage = 'قريبًا سيتم إضافة المحتوى';
}
